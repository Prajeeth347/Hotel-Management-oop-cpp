...
void room_bookings::modify_name()
{
	...
	if(flag == 1){
		...
		cout<<endl<<endl;
		cout<<"Customer Name 	: "<<h[r].name<<endl<<endl;
		h[r].name = firstname[rand()%9]+' '+lastname[rand()%9];
		cout<<"New name generated randomly : "<<h[r].name<<endl;
		cout<<"Customer name changed successfully"<<endl<<endl<<endl;
	}
}
void room_bookings::modify_phone()
{
	...
	if(flag == 1){
		...
		cout<<endl<<endl;
		cout<<"Customer Mobile	: "<<h[r].phone<<endl<<endl;
		h[r].phone = firstphone[rand()%9] + lastphone[rand()%9];
		cout<<"New contact number generated randomly : "<<h[r].phone<<endl<<endl;
...
void room_bookings::modify_address()
{
	...
	if(flag == 1){
		...
		cout<<endl<<endl;
		cout<<"Customer Address: "<<h[r].address<<endl<<endl;
		h[r].address = colony[rand()%9] + ',' + city[rand()%9];
		cout<<"New address generated randomly : "<<h[r].address<<endl<<endl;
...
void room_bookings::modify_days()
{
	...
	if(flag == 1){
		...
		cout<<endl<<endl;
		h[r].days = rand()%5+1;
		cout<<"New days generated randomly : "<<h[r].days<<endl<<endl;
...
void food_bookings::restaurant(){
	int choice,flag,roomno,selected;
